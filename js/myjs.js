          ...
          if(data["status"] === "true"){
			  ...
			  if(source === "ydl"){
				...
				var videoFormats = "";
				   ...
				   availableVideoFormats.forEach((format) => {console.log("format.id : "+format.id+", format.format_code"+format.format_code+", format.format_resolution : "+format.format_resolution);});
				   $.each(data, function(k, v){ 
					 if(isValidFormat(k)){
